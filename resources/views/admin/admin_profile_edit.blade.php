			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
					...
					<div class="col-md-6">
					<img class="rounded-circle" src="{{ (!empty($editdata->profile_photo_path))? url('upload/admin_images/'.$editdata->profile_photo_path): url('upload/no_image.jpg') }}" alt="User Avatar" style="width: 100px;, height=100px;" id="showImage">
					</div>	
