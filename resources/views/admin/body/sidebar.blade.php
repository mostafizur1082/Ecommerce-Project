      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview {{ ($prefix == '/slider')? 'active': '' }}">
         ...
         <li class="treeview {{ ($prefix == '/coupons')?'active':'' }}  ">
          ...
          <ul class="treeview-menu">
            <li class="{{ ($route == 'manage-coupon')? 'active':'' }}"><a href="{{ route('manage-coupon') }}"><i class="ti-more"></i>Manage Coupon</a>
          </li>
          </ul>
        </li>
        ...
        <li class="treeview {{ ($prefix == '/alluser')?'active':'' }}  ">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ ($route == 'all-users')? 'active':'' }}"><a href="{{ route('all-users') }}"><i class="ti-more"></i>All User</a></li> 
          </ul>
        </li> 
