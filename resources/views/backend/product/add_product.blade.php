...
<div class="row"> <!-- start 4th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
				 <input type="text" name="product_tags_bn" class="form-control" data-role="tagsinput" required="">
	 ...
	 @enderror
			...
			<div class="controls">
	 <input type="text" name="product_size_bn" class="form-control" data-role="tagsinput" required="">
...
<div class="row"> <!-- start 5th row  -->
	 ...
	 @enderror
			...
			<div class="controls">
	 <input type="text" name="product_color_bn" class="form-control" data-role="tagsinput" required="">
