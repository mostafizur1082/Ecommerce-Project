		  ...
		  <div class="row">
			<div class="col-12">
				...
				<div class="box-header with-border">
				  <h3 class="box-title">All Reguster User List
					  ...
					  <table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="" class="btn btn-info"><i class="fa fa-edit" aria-hidden="true"></i></a>
									<a href="" class="btn btn-danger" id="delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
								</td>
							</tr>
							@endforeach
						</tbody>
